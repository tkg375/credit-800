...
const features = [
  ...
  { title: "Credit Monitoring", description: "Stay on top of changes to your credit profile with real-time monitoring and instant alerts." },
  { title: "Investment Tools", description: "Explore investment funds, strategies, and asset allocation calculators to start building wealth alongside your credit." },
