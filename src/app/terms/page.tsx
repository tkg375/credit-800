        ...
        <div className="prose prose-slate max-w-none space-y-6">
          ...
          <section>
            ...
            <p className="text-slate-600 leading-relaxed mb-3">
              Credit 800 is a free credit repair platform that includes:
            </p>
            <ul className="list-disc list-inside text-slate-600 space-y-2 ml-4 mb-4">
              <li>AI-powered credit report analysis and FCRA-compliant dispute letter generation</li>
              <li>Credit score tracking, debt payoff planning, budget management, credit score simulator</li>
              <li>CFPB complaint generator, document vault, debt collector letter analyzer, bureau response analyzer</li>
              <li>Optional physical USPS mailing of dispute letters ($2/letter, charged at time of mailing)</li>
            </ul>
            <p className="text-slate-600 leading-relaxed">
              All features are free. The only charge is the optional $2/letter USPS mailing fee, which is charged per letter at the time you choose to mail it.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-slate-600 leading-relaxed mb-3">
              Credit 800 is free. The only charge is the optional USPS physical mailing service.
            </p>
            <ul className="list-disc list-inside text-slate-600 space-y-2 ml-4">
              <li>USPS mailing is $2 per letter, charged at the time you choose to mail a letter</li>
              <li>There are no subscriptions, no monthly fees, and no recurring charges</li>
              <li>Payments are processed securely by Stripe. Credit 800 does not store your full payment card information</li>
              <li>Mailing fees are non-refundable once a letter has been submitted for mailing</li>
            </ul>
          </section>
